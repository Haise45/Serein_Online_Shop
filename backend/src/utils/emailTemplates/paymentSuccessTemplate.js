...
const paymentSuccessTemplate = (userName, order, guestTrackingUrl = null) => {
...
<head>
    <meta charset="UTF-8"><title>Thanh Toán Thành Công - Đơn Hàng #${order._id
      .toString()
      .slice(-6)}</title>
    <style>
    ...
    <div style="background-color: #f4f4f7; padding: 20px;">
        <div class="content">
            ...
            <div style="padding: 0 10px; font-size: 15px;">
                ...
                <p>Chúng tôi xác nhận đã nhận được thanh toán thành công cho đơn hàng <strong>#${order._id
                  .toString()
                  .slice(
                    -6
                  )}</strong>. Đơn hàng của bạn sẽ sớm được xử lý và vận chuyển.</p>
                ...
                <p style="text-align:center; margin: 30px 0;">
                    <a href="${orderDetailUrl}" class="button" target="_blank">Xem chi tiết đơn hàng</a>
                </p>
            </div>
