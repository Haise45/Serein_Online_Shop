    ...
    <div style="background-color: #f4f4f7; padding: 20px;">
        <div class="content">
            ...
            <div style="padding: 0 10px; font-size: 15px;">
                ...
                <p>Tin vui! Đơn hàng <strong>#${order._id
                  .toString()
                  .slice(
                    -6
                  )}</strong> của bạn tại ${shopName} đã được bàn giao cho đơn vị vận chuyển.</p>
                <p>Dự kiến thời gian giao hàng là trong vài ngày tới. Vui lòng chuẩn bị để nhận hàng.</p>
                ...
                <p style="text-align:center; margin: 30px 0;">
                    <a href="${orderDetailUrl}" class="button" target="_blank">Theo dõi đơn hàng</a>
                </p>
                <p style="margin-top: 25px;">Cảm ơn bạn đã tin tưởng và mua sắm!</p>
            </div>
